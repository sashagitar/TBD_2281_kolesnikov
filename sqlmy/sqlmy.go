...
func (s *Store) AddProdukt(id_user int, p *ProduktDB) (bool, error) {
...
func (s *Store) Trash(id int, id_user int) (bool, error) {
...
func (s *Store) Used(id int, id_user int) (bool, error) {
...
func (s *Store) SetFinish(id_user int, id int, date time.Time) (bool, error) {
...
func (s *Store) MoveInHolodos(id_user int, id int) (bool, error) {
...
func (s *Store) GetList(id_user int, bought bool, sort bool) (*[]ProduktDB, error) {
...
func (s *Store) GetUseList(id_user int) (*[]ProduktDB, error) {
...
func (s *Store) GetStats(id_user int, ts time.Time, tf time.Time) (int, int, error) {
	var use int
	var drop int
	var err error
